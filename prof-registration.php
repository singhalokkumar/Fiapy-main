...
if(isset($_POST['firstname'])){
	...
	$s = "select * from `prof-registration` . `registration`  where email = '$email' && phone = '$phoneno'  ";
	...
	$sql = "INSERT INTO `prof-registration` . `registration` ( `firstname`, `lastname`, `phone`, `email`, `password`) VALUES ( '$firstname', '$lastname', '$phoneno', '$email', '$password');";
